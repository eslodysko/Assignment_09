...
class FileIO:
        ...
        try:
            with open(file_name[0], 'w') as file:
                for disc in lst_Inventory:
                    print(disc.get_record())
                    file.write(disc.get_record())
            # TODO add code to save track data to file
        except Exception as e:
            print('There was a general error during saving!', e, e.__doc__, type(e), sep='\n')
    ...
    def load_inventory(file_name: list) -> list:
        ...
        try:
            ...
            print('There was a general error during loading!', e, e.__doc__, type(e), sep='\n')
